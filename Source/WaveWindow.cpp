...
{
    juce::Font theFont("AmiDOS Regular", "Regular", proportionOfWidth(0.03f));
    g.setFont(theFont);

    /* Main whit border of window */
    juce::Rectangle<float> sampleArea(getWidth(), getHeight());
    g.setColour(juce::Colours::white);
    g.drawRect(sampleArea, proportionOfWidth(0.03125f));

    /* Right and bottom blue rectangles */
    g.setColour(juce::Colour(0xff0054aa));
    g.drawRect(juce::Rectangle<float>(proportionOfWidth(0.973f), proportionOfHeight(0.11f), proportionOfWidth(0.022f), proportionOfHeight(0.78f)), proportionOfHeight(0.014f));
    g.fillRect(juce::Rectangle<float>(proportionOfWidth(0.033f), proportionOfHeight(0.91f), proportionOfWidth(0.934f), proportionOfHeight(0.08f)));
    ...
    g.fillRect(juce::Rectangle<float>(proportionOfWidth(0.0045f), proportionOfHeight(0.11f), proportionOfWidth(0.022f), proportionOfHeight(0.78f)));

    /* Black box around F and E */
    g.setColour(juce::Colours::black);
    g.fillRect(juce::Rectangle<float>(proportionOfWidth(0.0045f), proportionOfHeight(0.11f), proportionOfWidth(0.022f), proportionOfHeight(0.0975f)));
    g.fillRect(juce::Rectangle<float>(proportionOfWidth(0.0045f), proportionOfHeight(0.7925f), proportionOfWidth(0.022f), proportionOfHeight(0.0975f)));
    ...
    g.setColour(juce::Colours::white);
    g.setFont(juce::Font("Yamaha EBM10 Bold", "Bold", proportionOfWidth(0.022f)));
    g.drawText("F", juce::Rectangle<float>(proportionOfWidth(0.0065f), proportionOfHeight(0.114f), proportionOfWidth(0.022f), proportionOfHeight(0.0975f)), juce::Justification::centred, false);
    g.drawText("E", juce::Rectangle<float>(proportionOfWidth(0.0065f), proportionOfHeight(0.795f), proportionOfWidth(0.022f), proportionOfHeight(0.1f)), juce::Justification::centred, false);
}
